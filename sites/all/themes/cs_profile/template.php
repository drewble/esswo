...
/*
function cs_profile_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
*/
/*
function cs_profile_preprocess_page(&$vars,$hook) {
  //typekit
...
*/
/*
function cs_profile_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function cs_profile_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
*/
/*
function cs_profile_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function cs_profile_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function cs_profile_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function cs_profile_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/
/*
function cs_profile_form_alter(&$form, &$form_state, $form_id) {
  //if ($form_id == '') {
  //....
  //}
}
